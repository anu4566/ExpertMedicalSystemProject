...
public interface Queries {
	...
	public static final String PatSignUpCheck = "insert into patients(password,firstname,lastname,email,contact,pcktype,cardtype,cardnum,cvv,expdate) values(?,?,?,?,?,?,?,?,?,?)";
	public static final String DocSignUpCheck = "insert into doctors(password,firstname,lastname,email,contact,pcktype,cardtype,cardnum,cvv,expdate) values(?,?,?,?,?,?,?,?,?,?)";
	public static final String ResSignUpCheck = "insert into researchers(password,firstname,lastname,email,contact,pcktype,cardtype,cardnum,cvv,expdate) values(?,?,?,?,?,?,?,?,?,?)";
	...
	public static final String AddCase = "insert into reports(email,disease,symptom,case_id,medicines,date,flag) values(?,?,?,?,?,?,?)";
	...
	public static final String AddAptDetails = "insert into appointment(pemail,demail,insurance,primarydetails,additional,days,datetime) values(?,?,?,?,?,?,?)";
	public static final String updatePatientPack = "update patients set pcktype=? where email=?";
	public static final String updateDoctorPack = "update doctors set pcktype=? where email=?";
	public static final String updateResearcherPack = "update researchers set pcktype=? where email=?";
}
