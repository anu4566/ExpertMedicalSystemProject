...
<head>
   <meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <title>MedAssist Health Service</title>
		...
		<div class="intro-content">
			<div class="container">
				<div class="row">
					...
					<h2 class="h-ultra">MedAssist medical group</h2>
					</div>
					...
					<h4 class="h-light">Provide best quality healthcare for you</h4>
						...
						<ul class="lead-list">
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Affordable monthly premium packages</strong><br />Select the plan that is best for you. .</span></li>
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Choose your favorite doctor</strong><br />Get a quick appointment with a Specialist Doctor</span></li>
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Only use friendly environment</strong><br />a site that provides advice for improvement</span></li>
						</ul>
						...
						<div class="callaction bg-gray">
							<div class="row">
								<div class="col-md-8">
									...
									<p>Our goal of most emergency medical services is to either provide treatment to those in need of urgent medical care, with the goal of satisfactorily treating the presenting conditions, or arranging for timely removal of the patient to the next point of definitive care. </p>
									</div>
									</div>
								</div>
								<div class="col-md-4">
...
<!--  
		...
		<div class="container marginbot-50">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<p>MedAssist works with the best specialist Doctors around the globe to provide help.</p>
					</div>
					</div>
	...
	<!-- Section: works -->
    <section id="healthnews" class="home-section paddingbot-60">
		<div class="container marginbot-50">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					<div class="wow fadeInDown" data-wow-delay="0.1s">
					<div class="section-heading text-center">
					<h2 class="h-bold">Health News</h2>
					<p>Keep up to date with the latest news in health, including recent announcements and new research. </p>
					</div>
					</div>
					<div class="divider-short"></div>
				</div>
			...
			<div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12" >
                    ...
                    <div id="owl-works" class="owl-carousel">
                        <div class="item"><a href="http://www.cnn.com/health" title="Click here to get CNN health news" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/1@2x.jpg"><img src="img/photo/cnn.png" class="img-responsive" alt="img"></a></div>
                        <div class="item"><a href="http://www.foxnews.com/health.html" title="Click here to get FOX health news" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/2@2x.jpg"><img src="img/photo/foxnews.jpg" class="img-responsive " alt="img"></a></div>
                        <div class="item"><a href="http://www.huffingtonpost.com/health-news/" title="Click here to get HuffPost health news" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/3@2x.jpg"><img src="img/photo/huffpost.png" class="img-responsive " alt="img"></a></div>
                        <div class="item"><a href="http://www.nbcnews.com/health" title="Click here to get NBC health news" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/4@2x.jpg"><img src="img/photo/nbc.png" class="img-responsive " alt="img"></a></div>
                    </div>
					</div>
                </div>
            </div>
                    ...
                    <div class="item active">
                	    <div class="col-md-4 col-sm-6">
        				    <div class="block-text rel zmin">
						        ...
						        <p>As an expert reviewer, MedAssist has given me a unique and deeply rewarding opportunity to work directly with patients, helping them better understand their medical condition, find validation and empathy, and move one step closer to a diagnosis or effective treatment. ...</p>
            			...
            			<div class="col-md-4 col-sm-6 hidden-xs">
						    <div class="block-text rel zmin">
						        ...
						        <p>Part of the cutting edge today, and the future of health and medicine, is empowering the individual as a patient or a consumer, and empowering the clinician ...</p>
							    <ins class="ab zmin sprite sprite-i-triangle block"></ins>
				            </div>
							<div class="person-text rel text-light">
						...
						<div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
							<div class="block-text rel zmin">
						        ...
						        <p>By utilizing MedAssist, one accesses not just one physician but one can access hundreds or even thousands of physicians from all different spectrums and backgrounds and specialties. ...</p>
							    <ins class="ab zmin sprite sprite-i-triangle block"></ins>
							</div>
							<div class="person-text rel text-light">
                    ...
                    <div class="item">
                        <div class="col-md-4 col-sm-6">
        				    <div class="block-text rel zmin">
							    ...
							    <div class="mark">My rating: <span class="rating-input"><span data-value="0" class="glyphicon glyphicon-star"></span><span data-value="1" class="glyphicon glyphicon-star"></span><span data-value="2" class="glyphicon glyphicon-star"></span><span data-value="3" class="glyphicon glyphicon-star"></span><span data-value="4" class="glyphicon glyphicon-star-empty"></span><span data-value="5" class="glyphicon glyphicon-star-empty"></span>  </span></div>
						        <p>I can't thank the founders of MedAssist enough. After years of struggling and living in terrified uncertainty, I actually have a diagnosis and am beginning treatment. ...</p>
							    <ins class="ab zmin sprite sprite-i-triangle block"></ins>
					        </div>
							<div class="person-text rel text-light">
            			...
            			<div class="col-md-4 col-sm-6 hidden-xs">
						    <div class="block-text rel zmin">
							    ...
							    <div class="mark">My rating: <span class="rating-input"><span data-value="0" class="glyphicon glyphicon-star"></span><span data-value="1" class="glyphicon glyphicon-star"></span><span data-value="2" class="glyphicon glyphicon-star-empty"></span><span data-value="3" class="glyphicon glyphicon-star-empty"></span><span data-value="4" class="glyphicon glyphicon-star-empty"></span><span data-value="5" class="glyphicon glyphicon-star-empty"></span>  </span></div>
						        <p>MedAssist has been the breath of fresh air for which I have been desperately searching for years. It may very well be the one thing that will give me back control of my life. ...</p>
							    <ins class="ab zmin sprite sprite-i-triangle block"></ins>
				            </div>
							<div class="person-text rel text-light">
						...
						<div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
							<div class="block-text rel zmin">
								...
								<div class="mark">My rating: <span class="rating-input"><span data-value="0" class="glyphicon glyphicon-star"></span><span data-value="1" class="glyphicon glyphicon-star"></span><span data-value="2" class="glyphicon glyphicon-star"></span><span data-value="3" class="glyphicon glyphicon-star"></span><span data-value="4" class="glyphicon glyphicon-star"></span><span data-value="5" class="glyphicon glyphicon-star"></span>  </span></div>
						        <p>All of the 'doctors' who participated were extremely helpful, friendly and conscientious in seeking more info. CrowdMed went beyond what any MD or specialist has done for me, so far. ...</p>
							    <ins class="ab zmin sprite sprite-i-triangle block"></ins>
							</div>
							<div class="person-text rel text-light">
			...
			<div class="row">
				...
				<div class="col-sm-4 pricing-box">
					...
					<div class="pricing-content general">
						...
						<h3>$99<sup>.99</sup> <span>/ one time</span></h3>
						<ul>
				...
				<div class="col-sm-4 pricing-box featured-price">
					...
					<div class="pricing-content featured">
						<h2>Elite Package</h2>
						<h3>$499<sup>.99</sup> <span>/ one time</span></h3>
						<ul>
							<li>Anthropometry (BMI, WH Ratio) <i class="fa fa-check icon-success"></i></li>
							<li>Post Examination Review <i class="fa fa-check icon-success"></i></li>
							<li>General Screening – Basic <i class="fa fa-check icon-success"></i></li>
				...
				<div class="col-sm-4 pricing-box">
					...
					<div class="pricing-content general last">
						...
						<h3>$249<sup>.99</sup> <span>/ one time</span></h3>
						<ul>
							<li>Anthropometry (BMI, WH Ratio) <i class="fa fa-check icon-success"></i></li>
							<li>Post Examination Review <i class="fa fa-check icon-success"></i></li>
